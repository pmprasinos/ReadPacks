...
Public Class PdfManipulation2
    ...
    Public Shared Function ParsePdfText(ByVal sourcePDF As String, _
        ...
        Try
            ...
            For i As Integer = fromPageNum To toPageNum Step 1
                ...
                If Not IsNothing(raFile) Then

                    token = New iTextSharp.text.pdf.PRTokeniser(raFile)
    ...
    Public Shared Sub ComparePdfs(ByVal pdf1 As String, ByVal pdf2 As String, _
        ...
        Try
            ...
            Dim raFile1 As iTextSharp.text.pdf.RandomAccessFileOrArray = Nothing
            ...
            Dim raFile2 As iTextSharp.text.pdf.RandomAccessFileOrArray = Nothing
            ...
            For i As Integer = fromPageNum To toPageNum Step 1
                ...
                raFile2 = New iTextSharp.text.pdf.RandomAccessFileOrArray(pdf1)
                raFile2 = New iTextSharp.text.pdf.RandomAccessFileOrArray(pdf2)
                If Not IsNothing(raFile2) AndAlso Not IsNothing(raFile2) Then
                    token1 = New iTextSharp.text.pdf.PRTokeniser(raFile1)

                    token2 = New iTextSharp.text.pdf.PRTokeniser(raFile2)
    ...
    Public Shared Sub ExtractPdfPages(ByVal sourcePdf As String, ByVal pageNumbersToExtract As List(Of Integer), ByVal outPdf As String)
        ...
        Try
            ...
            If Not IsNothing(outlines) Then
